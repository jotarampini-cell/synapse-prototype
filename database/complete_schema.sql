-- =====================================================
-- ESQUEMA COMPLETO DE SYNAPSE - TODAS LAS FUNCIONALIDADES
-- =====================================================
...
-- =====================================================
-- NUEVAS TABLAS PARA FUNCIONALIDADES IMPLEMENTADAS
-- =====================================================
...
CREATE TABLE IF NOT EXISTS sources (
    ...
    metadata JSONB, -- Para almacenar metadatos adicionales
    created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW(),
    updated_at TIMESTAMP WITH TIME ZONE DEFAULT NOW()
);
...
CREATE TABLE IF NOT EXISTS tasks (
    ...
    estimated_time TEXT, -- ej: "30 min", "2 horas"
    dependencies UUID[], -- IDs de otras tareas
    tags TEXT[],
    created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW(),
    updated_at TIMESTAMP WITH TIME ZONE DEFAULT NOW()
);
...
CREATE TABLE IF NOT EXISTS action_plans (
    ...
    title TEXT NOT NULL,
    description TEXT,
    steps JSONB, -- Array de pasos con estructura: {id, title, description, priority, estimatedTime, dependencies, completed}
...
CREATE TABLE IF NOT EXISTS ai_feedback (
    ...
    feedback_data JSONB, -- Datos específicos del feedback
...
CREATE TABLE IF NOT EXISTS ai_conversations (
    ...
    user_id UUID REFERENCES profiles(id) ON DELETE CASCADE NOT NULL,
    content_id UUID REFERENCES contents(id) ON DELETE CASCADE,
    messages JSONB, -- Array de mensajes con estructura: {role, content, timestamp}
    context JSONB, -- Contexto adicional de la conversación
    created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW(),
    updated_at TIMESTAMP WITH TIME ZONE DEFAULT NOW()
);
...
CREATE TABLE IF NOT EXISTS user_onboarding (
    ...
    completed_steps JSONB DEFAULT '[]', -- Array de pasos completados
...
-- Insertar carpetas predeterminadas para nuevos usuarios
